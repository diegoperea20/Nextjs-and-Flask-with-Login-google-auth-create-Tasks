...
function Login({API_URL}) {
  ...
  return (
    ...
    <button  className="loginButtonGoogle" onClick={handleGoogle}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
...
</svg>Login / Register with Google</button>
    <br />
    <br />
